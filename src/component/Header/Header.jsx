    ...
    <>
      <nav className="bg-slate-50">
        <div className="flex justify-between items-center px-4 py-2 md:px-10 lg:px-20">
          <span className="text-2xl sm:text-2xl lg:text-3xl font-bold text-orange-950">RealSpace Groups</span>
          <button className="block sm:hidden" onClick={handleClick}>
            {click ? <FaTimes /> : <CiMenuFries />}
          </button>
          <ul className="hidden sm:flex sm:gap-16 px-18 font-semibold text-lg  py-4">
            <li>
